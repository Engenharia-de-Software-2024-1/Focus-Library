...
public class PerfilManagerDB
{
    ...
    public async Task<Perfil> ObterPerfil(string token)
    {
        using (HttpClient client = new HttpClient())
        {
            ...
            HttpResponseMessage response = await client.GetAsync(Constants.BACKEND_URL + "/usuario");
    ...
    public async Task AtualizarPerfil(Perfil perfil, string token)
    {
        ...
        using (HttpClient client = new HttpClient())
        {
            ...
            string putUrl = Constants.BACKEND_URL + "/usuario/dadosgerais/" + perfil.Id;
    ...
    public async Task<string> RefreshToken()
    {
        ...
        using (HttpClient client = new HttpClient())
        {
            string refreshUrl = $"{Constants.BACKEND_URL}/auth/refresh?refreshToken={refreshToken}";
